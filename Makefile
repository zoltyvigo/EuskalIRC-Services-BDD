...
OBJS =	actions.o akill.o  channels.o chanserv.o commands.o compat.o \
	...
	jokuserv.o statserv.o registrate.o autolimit.o nicksuspends.o chanakicks.o geoip.o xserv.o\
	$(VSNPRINTF_O)
SRCS =	actions.c akill.c  channels.c chanserv.c commands.c compat.c \
	...
	jokuserv.c statserv.c registrate.c autolimit.c nicksuspends.c chanakicks.c geoip.c xserv.c\
	$(VSNPRINTF_C)
...
chanakicks.o:	 chanakicks.c	services.h pseudo.h
