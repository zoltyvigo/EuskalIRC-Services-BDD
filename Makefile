...
OBJS =	actions.o akill.o  channels.o chanserv.o commands.o compat.o \
	...
	jokuserv.o statserv.o registrate.o autolimit.o nicksuspends.o chanakicks.o geoip.o \
	$(VSNPRINTF_O)
SRCS =	actions.c akill.c  channels.c chanserv.c commands.c compat.c \
	...
	jokuserv.c statserv.c registrate.c autolimit.c nicksuspends.c chanakicks.c geoip.c\
	$(VSNPRINTF_C)
